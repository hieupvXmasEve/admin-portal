...
- Follow-up cut-over verification: `./scripts/dev.sh test --compact tests/Feature/StudentApplication/IndexCampusScopeTest.php tests/Feature/StudentApplication/DocumentsTest.php tests/Feature/StudentApplication/ExportTest.php tests/Feature/StudentApplication/StaffLifecycleTest.php tests/Feature/StudentApplication/GuardiansTest.php tests/Feature/StudentApplication/AuthorizationTest.php tests/Feature/Admissions/IngestionApplicationsTest.php tests/Feature/Architecture/AdmissionsOwnerContractsArchTest.php`.
- `./scripts/dev.sh composer exec pint -- --dirty --format agent` and `./scripts/dev.sh artisan migration-debt:inventory --check --format=table` passed after the final boundary cut-over.
