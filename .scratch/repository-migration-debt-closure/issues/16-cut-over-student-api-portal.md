...
This issue remains `ready-for-agent`; no acceptance criterion is marked complete. It still depends on the open Progression & Lifecycle architecture issue (12), and the remaining profile study-plan/academic-history, curriculum, timetable, grade, finance, and notification-preference route cut-overs require their owner-boundary implementations before this API-wide issue can be completed.
