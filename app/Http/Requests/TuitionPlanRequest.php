...
class TuitionPlanRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'terms.*.semester_id' => ['required', 'integer', 'exists:semesters,id'],
    ...
    public function messages(): array
    {
        return [
            ...
            'terms.*.semester_id.required' => 'Semester is required for each term.',
            'terms.*.semester_id.exists' => 'The selected semester does not exist.',
