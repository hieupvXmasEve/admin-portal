...
class StoreStudentApplicationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'submitted_photo' => 'nullable|url',
            'submitted_cccd' => 'nullable|url',
            'submitted_ccta' => 'nullable|url',
            'submitted_tn_translate' => 'nullable|url',
            'submitted_hb_translate' => 'nullable|url',
            'submitted_other' => 'nullable|url',
            'submitted_insurance_card' => 'nullable|url',
            'submitted_exemption_gc' => 'nullable|url',
