...
class StoreStudentApplicationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'campus_code' => 'required|string|max:20|exists:campuses,code',
            'intended_program' => 'required|string|max:100|exists:programs,code',
            'intended_specialization' => 'nullable|string|max:100|exists:specializations,code',
