...
class StoreQueryReplyRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'attachment.mimes' => 'The attachment must be a file of allowed type.',
            'attachment.mimetypes' => 'The attachment must be a file of allowed MIME type.',
        ];
    }
}
