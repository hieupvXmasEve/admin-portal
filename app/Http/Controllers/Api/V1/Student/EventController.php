...
class EventController extends Controller
{
    ...
    public function register(Request $request, Event $event): JsonResponse
    {
        try {
            ...
            $participant = $this->participationService->registerStudent($event, $student);
    ...
    public function unregister(Request $request, Event $event): JsonResponse
    {
        try {
            ...
            $success = $this->participationService->unregisterStudent($event, $student);
    ...
    public function myEvents(Request $request): JsonResponse
    {
        try {
            ...
            $participations = $this->participationService->getStudentParticipations($student, $filters);
