...
use App\Modules\Finance\Queries\Reporting\ExportStudentScholarshipApplicationQuery;
use Illuminate\Support\Facades\File;

class ExportStudentScholarshipApplicationCsvAction
{
    public function __construct(
        private readonly ExportStudentScholarshipApplicationQuery $query,
    ) {}
