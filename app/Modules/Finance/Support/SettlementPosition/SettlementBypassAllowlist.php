...
final class SettlementBypassAllowlist
{
    ...
    public static function entries(): array
    {
        return [
            ...
            'app/Http/Resources/Api/V1/Student/StudentInvoiceResource.php' => self::legacy('Finance', 'wave-3', 'Student invoice balance projection pending reader cutover.'),
            ...
            'app/Modules/Finance/Queries/Dng/ListDngWorklistQuery.php' => self::legacy('Finance', 'wave-4', 'DNG worklist balance projection pending reader cutover.'),
            'app/Modules/Finance/Queries/Reporting/ListCollectionProgressQuery.php' => self::legacy('Finance', 'wave-5', 'Collection report formula pending canonical report cutover.'),
