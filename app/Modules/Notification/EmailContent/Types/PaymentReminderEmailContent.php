...
final class PaymentReminderEmailContent implements EmailContentProvider, EmailVariableSchema
{
    ...
    public function htmlBody(array $data): string
    {
        ...
        <p style="text-align: left;"><span style="color: rgb(0, 0, 0);">Dear <strong>{$studentNameCode},</strong></span></p>
        <p style="text-align: left;"><span style="color: rgb(0, 0, 0);">This is a reminder to complete your tuition fee payment for <strong>{$semesterCode}</strong>. Please disregard this email if the tuition fee has already been paid.</span></p>
        ...
        <p style="text-align: left;"><span style="color: rgb(0, 0, 0);">Thân gửi <strong>{$studentNameCode},</strong></span></p>
        <p style="text-align: left;"><span style="color: rgb(34, 34, 34);">Phòng Dịch vụ Sinh viên (Student Services) xin thông báo nhắc nhở về việc thanh toán học phí</span><span style="color: rgb(0, 0, 0);"> cho <strong>{$semesterCode}</strong>. Vui lòng bỏ qua email này nếu sinh viên đã thanh toán học phí.</span></p>
