...
use App\Modules\Notification\Support\EloquentTuitionNoticeDeliveryReader;
...
class NotificationServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->bind(TuitionNoticeDeliveryReader::class, EloquentTuitionNoticeDeliveryReader::class);
