...
use App\Modules\Academic\Delivery\Http\Requests\CourseDelivery\RemoveCourseOfferingRosterMemberRequest;
use App\Modules\Academic\Delivery\Http\Requests\CourseDelivery\BulkAssignInstructorsRequest;
use App\Modules\Academic\Delivery\Http\Requests\CourseDelivery\BulkUpdateCourseRegistrationStatusRequest;
use App\Modules\Academic\Delivery\Http\Requests\MoveStudentRequest;
    ...
    public function removeStudent(
        ...
        try {
            RemoveCourseOfferingRosterMemberAction::run([
                ...
                'campus_id' => (int) $courseOffering->campus_id,
            ]);
