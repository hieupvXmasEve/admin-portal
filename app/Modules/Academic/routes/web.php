...
use App\Modules\Academic\Delivery\Http\Web\Admin\CourseOfferingBulkDeletionController;
use App\Modules\Academic\Delivery\Http\Web\Admin\CourseOfferingCatalogFormController;
...
use App\Modules\Academic\Delivery\Http\Web\FinalizeCourseOfferingController;
use App\Modules\Academic\Delivery\Http\Web\RecalculateApplyController;
use App\Modules\Academic\Delivery\Http\Web\RecalculatePreviewController;
...
use App\Modules\Academic\Progression\Http\Web\BulkMajorPlacementImportController;
...
// Scholarship adjustment dossiers (Phase 3): Academic-owned maker-checker
// workflow. Route-level `can:` gates use the Phase 1 permission slugs;
// record-level campus scoping is enforced in the controller/policy.
Route::middleware(['auth', 'verified'])->group(function () {
    Route::prefix('scholarship-adjustments')->name('scholarship-adjustments.')->group(function () {
        ...
        Route::get('candidates/preview', [ScholarshipAdjustmentDossierController::class, 'candidatesPreview'])
        ...
        Route::post('{dossier}/decision-preview', [ScholarshipAdjustmentDossierController::class, 'decisionPreview'])
            ->middleware('can:view_scholarship_adjustment')
            ->name('decision-preview');

        Route::post('{dossier}/interview/minutes', [ScholarshipAdjustmentDossierController::class, 'editMinutes'])
            ->middleware('can:manage_scholarship_interview')
            ->name('interview.minutes');

        Route::post('{dossier}/overrule-dispute', [ScholarshipAdjustmentDossierController::class, 'overruleDispute'])
            ->middleware('can:approve_scholarship_adjustment')
            ->name('overrule-dispute');
