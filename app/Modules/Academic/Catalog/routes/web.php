...
use App\Modules\Academic\Catalog\Http\Web\ModuleController;
...
// Retired from frozen routes/web/modules.php verbatim: this admin CRUD screen
// carried no can: gate there either, so none is added here.
