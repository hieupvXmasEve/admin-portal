...
use App\Modules\Academic\Progression\Support\EloquentStudentDirectoryStatisticsReader;
use App\Modules\Academic\Progression\Support\EloquentStudentLifecycleActionReader;
use App\Modules\Academic\Progression\Support\EloquentStudentLifecycleMatcher;
...
class AcademicServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->bind(StudentLifecycleMatcher::class, EloquentStudentLifecycleMatcher::class);
        $this->app->bind(StudentDirectoryStatisticsReader::class, EloquentStudentDirectoryStatisticsReader::class);
