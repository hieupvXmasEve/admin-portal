...
final class EventOperations
{
    ...
    protected EventNotificationPublisher $notificationPublisher;
    ...
    public function completeEvent(Event $event): Event
    {
        ...
        return DB::transaction(function () use ($event) {
            ...
            $goldAwardedCount = 0;
            $participationService = app(EventParticipationOperations::class);
    ...
    protected function notifyParticipantsOfUpdate(Event $event): void
    {
        ...
        foreach ($participants as $participant) {
            $this->notificationPublisher->notifyEventUpdate($event, (int) $participant->student_id);
        }
    }
}
