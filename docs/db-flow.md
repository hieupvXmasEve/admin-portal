...
- **Phụ thuộc**: `course_offerings.unit_id` -> `units.id`; `course_offerings.semester_id` -> `semesters.id`; `course_offerings.lecturer_id` -> `lecturers.id`; `course_offerings.campus_id` -> `campuses.id`
