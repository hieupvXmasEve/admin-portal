...
| 1.2 | `AI-MOD-002-ai-audit-evaluation-foundation` | `S-002-ai-audit-evaluation-foundation/` | planned | Conversation/message/tool-call/provider-usage audit records, redaction rules, and baseline evaluation dataset | 000 |
| 1.3 | `AI-MOD-003-metric-catalog-query-plan` | `S-003-metric-catalog-query-plan/` | planned | Business glossary subset, MetricCatalog, filter/group-by allowlists, QueryPlanValidator, and 3-5 real staff questions | 001, 002 |
