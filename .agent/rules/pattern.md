...
**Objective:**
Strictly follow the `Action-Request-Resource Pattern` (replacing the old Service-Request-Resource pattern) when implementing or modifying any module. Ensure the codebase is well-structured, maintainable, and scalable.
...
- `app/Actions/<Domain>` (e.g., `app/Actions/Room`)
...
- Location: `app/Actions/<Domain>/<Verb><Entity>Action.php`
...
- Location: `app/Http/Requests/<ModuleName>/*.php`
...
- Location: `app/Http/Resources/<ModuleName>/*.php`
- Create resources to transform models into JSON responses.

### 5. Implement Controllers

**Web Controller** (`app/Http/Controllers/Web/RoomController.php`)

- **Use**: FormRequests.
- **Call**: The appropriate `Action`.
- **Return**: Inertia response (`Inertia::render(...)`).

**API Controller** (`app/Http/Controllers/Api/RoomController.php`)
