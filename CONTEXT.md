...
| **Finance Charge** _(Finance)_ | The first committed Finance-owned payable obligation created from an approved candidate or Finance rule. It is the source of obligation; later corrections use adjustment, reversal, credit, or new candidates rather than rewriting committed money. |
