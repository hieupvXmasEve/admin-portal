...
2. **Course Delivery** — mở lớp, xếp lịch, đăng ký môn, học lại, thi lại.
3. **Attendance & Completion** — theo dõi điểm danh, lọc sinh viên rớt môn.
4. **Grades & Performance** — chốt điểm, GPA, cảnh báo học vụ.
...
| [Course Delivery](/academic-operations/course-delivery/) | Mở lớp, xếp lịch, đăng ký sinh viên, xử lý học lại và thi lại |
| [Attendance & Completion](/academic-operations/attendance-completion/) | Kiểm tra điểm danh, sinh viên rớt môn, thống kê lớp |
| [Grades & Performance](/academic-operations/grades-performance/) | Chốt GPA, tra kết quả cũ, xem sinh viên bị cảnh báo |
