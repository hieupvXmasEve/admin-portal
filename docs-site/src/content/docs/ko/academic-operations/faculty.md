...
**Academic Operations**의 **Faculty**는 강의 인력을 관리합니다. 누가 강의하는지, 시수는 얼마인지, 담당 강좌의 성적은 어떠한지를 다룹니다.
...
1. **Academic Operations → Faculty → Lecturer List**로 이동합니다. 화면 이름은 **Lecturers**입니다.
...
1. **Academic Operations → Faculty → Lecturer Hours**로 이동합니다.
...
1. **Academic Operations → Faculty → Lecturer GPA**로 이동합니다.
