...
그다음에는 담당 업무 영역으로 이동하십시오. 아래 표의 열 개 영역이 메뉴 그룹 열 개와 그대로 대응합니다.
...
| [Academic Operations — 학사 운영](/ko/academic-operations/) | 작성 완료 |
| [Student Services — 학생 서비스](/ko/student-services/) | 작성 완료 |
| [Reports & Audits — 보고서 및 감사](/ko/reports-audits/) | 작성 완료 |
| [Faculty & Teaching — 교원 및 강의](/ko/faculty-teaching/) | 작성 완료 |
| [Finance Office — 등록금](/ko/finance-office/) | 작성 완료 |
| [Forms & Quality — 양식 및 설문](/ko/forms-quality/) | 작성 완료 |
| [Campus Operations — 캠퍼스 운영](/ko/campus-operations/) | 작성 완료 |
