...
**Campus** 管理教学时间之外的空间和活动：教室与活动。

Gold 兑换商城和学生社团已移至独立分组 **Store & Clubs**。
...
**操作步骤。** 进入 **Campus → Room Management → Rooms**，添加或编辑教室。
...
1. 进入 **Campus → Room Management → Find Available Rooms**。
...
1. 进入 **Campus → Room Management → Pending Approvals**。
2. 逐条审阅请求，批准或拒绝。
...
**操作步骤。** 进入 **Campus → Room Management → Room Usage Calendar**。点击 **Today** 返回今天。
...
**操作步骤。** 进入 **Campus → Events → List**，创建活动或打开已有活动。
...
| 安排补考时段 | Room Usage Calendar → Find Available Rooms → Exam Resit Schedule |
