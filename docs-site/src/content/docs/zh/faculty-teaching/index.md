...
**Faculty & Teaching** 管理教学队伍：谁在授课、授课多少小时、所负责班级的成绩表现如何。
...
1. 进入 **Faculty & Teaching → Lecturer List**。界面名称为 **Lecturers**。
...
1. 进入 **Faculty & Teaching → Lecturer Hours**。
...
1. 进入 **Faculty & Teaching → Lecturer GPA**。
