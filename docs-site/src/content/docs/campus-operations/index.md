...
**Campus Operations** quản lý không gian và hoạt động ngoài giờ học: phòng ốc, sự kiện, câu lạc bộ, cửa hàng đổi Gold.
...
1. Vào **Campus Operations → Merchandise → Store**.
...
1. Vào **Campus Operations → Merchandise → Redemption Orders**.
2. Mở đơn cần xử lý.
