...
export const studentRoutes = {
    ...
    academicProgressionDeferReturns: () => route('reports.academic-progression.defer-returns'),
    academicProgressionDeferReturnsExport: () => route('reports.academic-progression.defer-returns.export'),
    scholarshipRestorationWatchlist: () => route('reports.scholarship-restorations.index'),
    scholarshipRestorationWatchlistExport: () => route('reports.scholarship-restorations.export'),
...
export const financeRoutes = {
    ...
    student360: {
        ...
        recordPaymentPreview: (studentId: number) => route(FINANCE_ROUTE_NAMES.STUDENT_PAYMENT_PREVIEW, { student: studentId }),
        paymentReceipt: (paymentId: number) => route(FINANCE_ROUTE_NAMES.PAYMENT_RECEIPT, { payment: paymentId }),
