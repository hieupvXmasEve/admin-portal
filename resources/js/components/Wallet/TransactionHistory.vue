...
<template>
  <div class="bg-white rounded-lg border border-gray-200">
    ...
    <div class="divide-y divide-gray-200">
            ...
            <div class="flex items-center space-x-4">
              ...
              <div class="flex-shrink-0">
                <div
                  :class="[
                    ...
                    transaction.type === 'spend' ? 'bg-red-100' : 'bg-blue-100'
                  ]"
                >
                  <!-- Earn icon -->
                  <svg
                  ...
                  <!-- Spend icon -->
                  <svg
                    v-else-if="transaction.type === 'spend'"
              ...
              <div class="min-w-0 flex-1">
                <p class="text-sm font-medium text-gray-900">
                  {{ transaction.type_label }} - {{ transaction.source_type_label }}
                </p>
                <p v-if="transaction.notes" class="text-xs text-gray-500 truncate">
                  {{ transaction.notes }}
                </p>
      ...
      <!-- Show more button -->
      <div v-if="showShowMore" class="px-6 py-3 bg-gray-50 border-t border-gray-200">
        <button
          @click="$emit('show-more')"
          class="w-full text-center text-sm font-medium text-blue-600 hover:text-blue-500 transition-colors"
        >
