...
import { DAYS_OF_WEEK, getDaysOfWeekOptions, getRoomStatusOptions, getRoomTypeOptions, roomFormSchema, type RoomFormData } from '@/schemas/room';
...
<template>
    ...
    <Form :validation-schema="validationSchema" :initial-values="initialValues" class="space-y-6" @submit="onSubmit">
                ...
                <div class="space-y-2">
                    ...
                    <div class="grid grid-cols-7 gap-2">
                        <div v-for="day in daysOfWeekOptions" :key="day.value" class="flex items-center space-x-2">
                            <Checkbox :id="`day-${day.value}`" :checked="isDayBlocked(day.value)" @update:checked="() => toggleBlockedDay(day.value)" />
