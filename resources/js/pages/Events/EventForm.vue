...
<template>
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-muted-foreground">Manage event information and rewards.</p>
        </div>
    ...
    <Card class="mt-6">
        <CardHeader>
            ...
            <CardDescription>
                Provide the key information about the event, including schedule and reward.
            </CardDescription>
        </CardHeader>
        <CardContent>
            <form class="space-y-8" @submit.prevent="submitForm">
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div class="space-y-2 md:col-span-2">
                        ...
                        />
                        <p v-if="form.errors.title" id="title-error" class="text-sm text-destructive">
                            {{ form.errors.title }}
                        </p>
                    </div>
                    ...
                    <div class="space-y-2 md:col-span-2">
                        ...
                        />
                        <p v-if="form.errors.description" id="description-error" class="text-sm text-destructive">
                    ...
                    <div class="space-y-2">
                        ...
                        />
                        <p v-if="form.errors.start_time" id="start-time-error" class="text-sm text-destructive">
                    ...
                    <div class="space-y-2">
                        ...
                        />
                        <p v-if="form.errors.end_time" id="end-time-error" class="text-sm text-destructive">
                    ...
                    <div class="space-y-2">
                        ...
                        />
                        <p v-if="form.errors.location" id="location-error" class="text-sm text-destructive">
                    ...
                    <div class="space-y-2">
                        ...
                        <Input
                            id="gold_reward_amount"
                            v-model="form.gold_reward_amount"
                            type="number"
                            step="0.01"
                            min="0"
                            required
                            :disabled="form.processing"
                            :aria-invalid="!!form.errors.gold_reward_amount"
                            aria-describedby="gold-reward-error"
                        />
                        <p v-if="form.errors.gold_reward_amount" id="gold-reward-error" class="text-sm text-destructive">
                    ...
                    <div class="space-y-2 md:col-span-2">
                        ...
                        />
                        <p v-if="form.errors.max_participants" id="max-participants-error" class="text-sm text-destructive">
                            {{ form.errors.max_participants }}
                        </p>
                        <p id="max-participants-help" class="text-sm text-muted-foreground">
