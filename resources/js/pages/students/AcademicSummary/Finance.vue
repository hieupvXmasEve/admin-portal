...
const scholarshipAmountLabel = (scholarship: FinanceScholarship): string =>
    scholarship.type === 'percentage' ? `${scholarship.amount}%` : formatCurrency(scholarship.amount);
</script>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-muted-foreground text-sm">
                                Fees, gold, and scholarships are shown for context. Payments, allocations, and adjustments are made in the
                                Finance Office.
                            </p>
                        </div>
                    </div>
