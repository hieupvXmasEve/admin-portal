...
const decisionLabel = (decision: LifecycleDecisionOption): string =>
    [decision.decision_number, decision.decision_name].filter(Boolean).join(' — ') || `Decision #${decision.id}`;
    ...
    <Dialog :open="open" @update:open="(value) => emit('update:open', value)">
        <DialogContent class="sm:max-w-lg">
            ...
            <div class="space-y-2 py-2">
                ...
                <p v-if="decisions.length === 0" class="text-muted-foreground text-sm">
                    No decisions are available yet. Create a Decision in the management area first.
                </p>
