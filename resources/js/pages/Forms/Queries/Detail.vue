...
const assignForm = useForm({
    assigned_to_user_id: props.ticket.assigned_to_user_id?.toString() || 'none',
    note: ''
});
    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                <Tabs default-value="conversation" class="w-full">
                    ...
                    <TabsContent value="history">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Trace back who assigned this ticket and when.</CardDescription>
                            </CardHeader>
                            <CardContent class="p-0">
                                <div v-if="auditHistory.length" class="divide-y">
                                ...
                                <div v-else class="p-8 text-center text-muted-foreground italic">
                            ...
                            <Select v-model="assignForm.assigned_to_user_id">
                                ...
                                <SelectContent>
                                    ...
                                    <template v-for="staff in staffs" :key="staff.id">
                                        <SelectItem v-if="staff.id" :value="staff.id.toString()">
                                            {{ staff.name }}
                                        </SelectItem>
                                    </template>
                                </SelectContent>
