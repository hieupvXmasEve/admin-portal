...
const hasActiveFilters = computed(() => 
    filters.value.booking_id || filters.value.action_type || filters.value.start_date || filters.value.end_date
);
...
const formatDateTime = (datetime: string) => new Date(datetime).toLocaleString('en-US', {
