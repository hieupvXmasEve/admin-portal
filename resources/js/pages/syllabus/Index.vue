                    ...
                    <TableRow v-for="syllabus in filteredSyllabi" :key="syllabus.id" :class="syllabus.is_active ? 'bg-green-50' : ''">
                        ...
                        <TableCell>
                            <div class="flex items-center gap-2">
                                ...
                                <Badge v-if="syllabus.total_assessment_weight === 100" class="bg-green-100 text-xs text-green-800"> Complete </Badge>
                        ...
                        <TableCell class="text-right">
                            <div class="flex items-center justify-end gap-1">
                                ...
                                <!-- View -->
                                <Button variant="ghost" size="sm" @click="router.visit(`/units/${unit.id}/syllabus/${syllabus.id}`)" title="View">
                                    <Eye class="h-4 w-4" />
                                </Button>
