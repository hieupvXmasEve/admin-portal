...
const handleApprove = () => {
    ...
    router.post(
        `/room-bookings/${selectedBooking.value.id}/approve`,
...
const handleReject = () => {
    ...
    processing.value = true;
    router.post(
        `/room-bookings/${selectedBooking.value.id}/reject`,
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            return h('div', { class: 'flex items-center space-x-2' }, [
                h(Button, { variant: 'default', size: 'sm', onClick: () => openApproveDialog(booking) }, () => [h(Check, { class: 'mr-1 w-4 h-4' }), 'Approve']),
                h(Button, { variant: 'destructive', size: 'sm', onClick: () => openRejectDialog(booking) }, () => [h(X, { class: 'mr-1 w-4 h-4' }), 'Reject']),
                h(Button, { variant: 'ghost', size: 'sm', onClick: () => viewBooking(booking.id) }, () => 'View'),
            ]);
        },
    },
];
...
<template>
    ...
    <div class="flex items-center justify-between">
        ...
        <Button variant="outline" @click="router.visit('/room-bookings')"> All Bookings </Button>
    </div>
    ...
    <Dialog v-model:open="showApproveDialog">
        <DialogContent>
            <DialogHeader>
                ...
                <DialogDescription> Are you sure you want to approve "{{ selectedBooking?.title }}"? </DialogDescription>
            </DialogHeader>
            <div class="py-4">
    ...
    <Dialog v-model:open="showRejectDialog">
        <DialogContent>
            <DialogHeader>
                ...
                <DialogDescription> Please provide a reason for rejecting "{{ selectedBooking?.title }}". </DialogDescription>
            </DialogHeader>
            <div class="py-4">
