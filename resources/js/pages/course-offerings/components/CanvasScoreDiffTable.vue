...
<template>
    <div class="space-y-4">
        <p class="text-muted-foreground text-sm">
            <span class="text-foreground font-semibold">{{ diff.summary.total_changes }}</span> change(s) across
            <span class="text-foreground font-semibold">{{ diff.summary.students_changed }}</span> student(s) ·
