...
const form = useForm<ScholarshipFormData>({
    ...
    amount: toNumber(props.scholarship.amount),
    total_amount: toNullableNumber(props.scholarship.total_amount),
    total_terms: toNullableNumber(props.scholarship.total_terms),
...
const submit = () => {
    ...
    })).put(route('scholarships.update', props.scholarship.id), {
        onSuccess: () => {
