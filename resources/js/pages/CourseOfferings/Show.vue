...
import CourseLifecycleHeader from '@/pages/CourseOfferings/components/CourseLifecycleHeader.vue';
import OverviewTab from '@/pages/CourseOfferings/components/tabs/OverviewTab.vue';
import type { ScoresData } from '@/pages/CourseOfferings/components/tabs/ScoresTab.vue';
import ScoresTab from '@/pages/CourseOfferings/components/tabs/ScoresTab.vue';
import SessionsTab from '@/pages/CourseOfferings/components/tabs/SessionsTab.vue';
import StudentsTab from '@/pages/CourseOfferings/components/tabs/StudentsTab.vue';
import type { SurveyData } from '@/pages/CourseOfferings/components/tabs/SurveyTab.vue';
import SurveyTab from '@/pages/CourseOfferings/components/tabs/SurveyTab.vue';
