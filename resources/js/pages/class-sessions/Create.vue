...
const onSubmit = handleSubmit((formValues) => {
    ...
    const data = {
        ...
        learning_objectives: formValues.learning_objectives 
            ? formValues.learning_objectives.split('\n').filter(line => line.trim()) 
            : [],
        required_materials: formValues.required_materials 
            ? formValues.required_materials.split('\n').filter(line => line.trim()) 
            : [],
        topics_covered: formValues.topics_covered 
            ? formValues.topics_covered.split('\n').filter(line => line.trim()) 
            : [],
    };
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Enter the session title, description, and course details.
                            </CardDescription>
                        </CardHeader>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Set the date, time, and duration for this session.
                            </CardDescription>
                        </CardHeader>
                        <CardContent class="space-y-6">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Define the learning objectives, topics, and materials for this session.
                            </CardDescription>
                        </CardHeader>
                        <CardContent class="space-y-6">
                            <!-- Learning Objectives -->
                            <FormField v-slot="{ componentField }" name="learning_objectives">
                                <FormItem>
                                    ...
                                    <p class="text-xs text-muted-foreground">Enter each objective on a new line</p>
                                    <FormMessage />
                                </FormItem>
                            </FormField>
                            ...
                            <FormField v-slot="{ componentField }" name="topics_covered">
                                <FormItem>
                                    ...
                                    <p class="text-xs text-muted-foreground">Enter each topic on a new line</p>
                                    <FormMessage />
                                </FormItem>
                            </FormField>
                            ...
                            <FormField v-slot="{ componentField }" name="required_materials">
                                <FormItem>
                                    ...
                                    <p class="text-xs text-muted-foreground">Enter each material on a new line</p>
                                    <FormMessage />
                                </FormItem>
                            </FormField>
                        </CardContent>
                            ...
                            <FormField v-slot="{ componentField }" name="instructor_notes">
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Textarea 
                                            v-bind="componentField" 
                                            placeholder="Notes for the instructor conducting this session"
                                            rows="4"
                                        />
                                    </FormControl>
                                    <FormMessage />
                ...
                <div class="space-y-6">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Configure attendance tracking for this session.
                            </CardDescription>
                        </CardHeader>
                        <CardContent class="space-y-6">
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="space-y-0.5">
                                            ...
                                            <p class="text-xs text-muted-foreground">
                                                Whether attendance is mandatory for this session
                                            </p>
                                        </div>
                                        <FormControl>
