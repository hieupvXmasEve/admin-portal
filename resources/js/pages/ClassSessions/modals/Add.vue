            ...
            <form class="space-y-5" @submit.prevent="submit">
                ...
                <div class="grid grid-cols-3 gap-3">
                    <div class="space-y-1.5">
                        ...
                        <DatePicker v-model="form.session_date" :disabled="atLimit" :class="{ 'border-destructive': form.errors.session_date }" :portal-to="modalContentRef ?? undefined" />
                    ...
                    <div class="space-y-1.5">
                        ...
                        <TimePicker v-model="form.start_time" :disabled="atLimit" :class="{ 'border-destructive': form.errors.start_time }" />
                    ...
                    <div class="space-y-1.5">
                        ...
                        <TimePicker v-model="form.end_time" :disabled="atLimit" :class="{ 'border-destructive': form.errors.end_time }" />
