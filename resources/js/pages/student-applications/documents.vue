        ...
        <div class="flex flex-wrap items-start justify-between gap-3">
            <div>
                ...
                <div class="text-muted-foreground mt-1 flex flex-wrap items-center gap-x-3 gap-y-1 text-sm">
                    ...
                    <span
                        v-if="application.is_international_applicant"
        ...
        <Card>
            ...
            <CardContent class="space-y-4">
                ...
                >
                    ...
                    <span><span class="font-semibold">{{ missingRequired.length }} required document(s) missing.</span></span>
                </div>
                ...
                <div
                    ...
                    :class="group.is_missing ? 'border-amber-300 bg-amber-50/40 dark:border-amber-700 dark:bg-amber-900/10' : ''"
                >
