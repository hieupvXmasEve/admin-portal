...
const createBuilding = () => {
    router.visit(route('campuses.buildings.create', props.campus.id));
};

const editBuilding = (building: Building) => {
    router.visit(route('campuses.buildings.edit', [props.campus.id, building.id]));
};
                        ...
                        <template #cell-actions="{ row }">
                            <div class="flex items-center gap-1">
                                ...
                                <Button
                                    ...
                                    @click="confirmDeleteBuilding(row.original)"
                                >
