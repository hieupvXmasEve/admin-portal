                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <div class="flex items-center justify-between text-xs">
                                                ...
                                                <div class="flex items-center gap-1">
                                                    <Button v-if="permission.can('edit_curriculum_unit')" variant="ghost" size="sm" title="Edit" @click="editCurriculumUnit(unit)">
                                                        <Edit class="h-3 w-3" />
                                                    </Button>
                                                    <Button v-if="permission.can('delete_curriculum_unit')" variant="ghost" size="sm" title="Delete" @click="deleteCurriculumUnit(unit)">
                ...
                <CardContent>
                    <div v-if="data.units.length === 0" class="py-8 text-center">
                        ...
                        <div class="text-muted-foreground mt-2 text-sm">
                            <span v-if="Object.values(filters).some((f) => f && f !== 'all')">Try adjusting your search filters.</span>
                                        ...
                                        <ComboboxList class="max-h-64 w-[var(--reka-combobox-trigger-width)] overflow-y-auto">
                                            <ComboboxViewport>
                                                <ComboboxEmpty v-if="filteredAvailableUnits.length === 0">
                                                    <span v-if="availableUnits.length === 0">No available units to add</span>
