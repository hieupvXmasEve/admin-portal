            ...
            <Card>
                <CardHeader>
                    <div class="flex items-center justify-between">
                        ...
                        <Button size="sm" @click="showManageModulesDialog = true" v-if="permission.can('edit_curriculum_version')" :disabled="!canEditOrDelete" :title="!canEditOrDelete ? 'Cannot modify for an active or past semester version' : ''">
                ...
                <CardContent>
                    ...
                    <div v-if="!curriculumVersion.curriculum_modules || curriculumVersion.curriculum_modules.length === 0" class="py-12 text-center">
                        ...
                        <Button
                            variant="outline"
                            @click="showManageModulesDialog = true"
                            v-if="permission.can('edit_curriculum_version')"
